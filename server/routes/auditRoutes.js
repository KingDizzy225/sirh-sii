...
// Intégrité de la chaîne : le journal se contrôle lui-même.
router.get('/integrite', requireRole(['ADMIN']), auditController.integrite);
router.post('/ancrer', requireRole(['ADMIN']), auditController.ancrer);
