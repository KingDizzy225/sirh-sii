...
export function RelationsEcolesCampus() {
  ...
  const [ecoles, setEcoles] = useState([
    {
      id: "SCH-001",
      nom: "INP-HB (Institut National Polytechnique Félix Houphouët-Boigny)",
      sigle: "INP-HB Yamoussoukro",
      type: "INGENIEUR", // INGENIEUR, UNIVERSITE, COMMERCE
      ville: "Yamoussoukro",
      conventione: true,
      dateSignatureConvention: "15/02/2023",
      dateRenouvellement: "15/02/2027",
      filieresCibles: ["Génie Logiciel & Informatique", "Télécoms & Réseaux", "Data Science & IA"],
      contactNom: "Prof. Tanoh Koffi (Directeur des Relations Entreprises)",
      contactEmail: "relations.entreprises@inphb.ci",
      contactTel: "+225 07 08 45 12 00",
      alumniChezSII: 14,
      stagiairesAccueillis: 6,
      statutConvention: "ACTIF", // ACTIF, A_RENOUVELER, EN_NEGOCIATION
      ambassadeurSII: "Moussa Soro (Responsable IT - Promo INP-HB 2018)"
    },
    {
      id: "SCH-002",
      nom: "ESATIC (École Supérieure Africaine des TIC)",
      sigle: "ESATIC Abidjan",
      type: "INGENIEUR",
      ville: "Abidjan (Treichville)",
      conventione: true,
      dateSignatureConvention: "10/06/2024",
      dateRenouvellement: "10/06/2027",
      filieresCibles: ["Cybersécurité & Réseaux", "Développement Web & Mobile", "IoT & Systèmes Embarqués"],
      contactNom: "Dr. Ahoua Coulibaly (Chef de Département)",
      contactEmail: "coulibaly.a@esatic.edu.ci",
      contactTel: "+225 05 44 89 23 10",
      alumniChezSII: 9,
      stagiairesAccueillis: 5,
      statutConvention: "ACTIF",
      ambassadeurSII: "Mamadou Bakayoko (Technicien Réseaux Datacenter)"
    },
    {
      id: "SCH-003",
      nom: "Université Félix Houphouët-Boigny (UFR MI & Informatique)",
      sigle: "UFHB Cocody",
      type: "UNIVERSITE",
      ville: "Abidjan (Cocody)",
      conventione: true,
      dateSignatureConvention: "20/01/2025",
      dateRenouvellement: "20/01/2028",
      filieresCibles: ["Master MIAGE (Méthodes Informatiques Appliquées à la Gestion)", "Licence Pro Réseaux"],
      contactNom: "Doyenne Pr. Bamba Mariam",
      contactEmail: "miage@ufhb.edu.ci",
      contactTel: "+225 07 11 22 33 44",
      alumniChezSII: 11,
      stagiairesAccueillis: 4,
      statutConvention: "ACTIF",
      ambassadeurSII: "Julie Konan (Chargée de Clientèle Senior)"
    },
    {
      id: "SCH-004",
      nom: "HEC Abidjan & MDE Business School",
      sigle: "MDE / HEC Abidjan",
      type: "COMMERCE",
      ville: "Abidjan (Cocody Riviera)",
      conventione: true,
      dateSignatureConvention: "05/04/2025",
      dateRenouvellement: "05/04/2027",
      filieresCibles: ["Management des SI", "Contrôle de Gestion & Finance", "Marketing Digital PME"],
      contactNom: "Mme Patricia Assi (Directrice Carrières)",
      contactEmail: "carrieres@mde.ci",
      contactTel: "+225 01 02 03 04 05",
      alumniChezSII: 6,
      stagiairesAccueillis: 3,
      statutConvention: "ACTIF",
      ambassadeurSII: "Jean-Marc Koffi (Directeur d'Agence Principale)"
    }
  ]);
  ...
  const [forums, setForums] = useState([
    {
      id: "EVT-2026-01",
      nom: "Forum Emploi & Carrières INP-HB 2026",
      ecoleOrganisatrice: "INP-HB Yamoussoukro",
      date: "14 Novembre 2026",
      lieu: "Campus Sud INP-HB, Yamoussoukro",
      format: "Présentiel (Stand Entreprise de 18m²)",
      statut: "CONFIRME", // CONFIRME, EN_ATTENTE, CLOTURE
      budgetEngage: "2 500 000 FCFA",
      ambassadeursMobilises: ["Moussa Soro", "Dr. Stéphane Touré (DRH)", "Kouadio Michel"],
      cvsObjectif: 80,
      cvsCollectes: 0,
      actionsPrevues: "Atelier simulation d'entretiens techniques & Conférence sur les métiers du Cloud en Afrique"
    },
    {
      id: "EVT-2026-02",
      nom: "Journée de l'Insertion Professionnelle ESATIC",
      ecoleOrganisatrice: "ESATIC Abidjan",
      date: "28 Octobre 2026",
      lieu: "Palais de la Culture d'Abidjan (Treichville)",
      format: "Présentiel (Stand Premium & Job Dating)",
      statut: "CONFIRME",
      budgetEngage: "1 800 000 FCFA",
      ambassadeursMobilises: ["Mamadou Bakayoko", "Fatou Camara"],
      cvsObjectif: 60,
      cvsCollectes: 0,
      actionsPrevues: "Speed-dating recrutement développeurs React/Node & stagiaires pré-embauche"
    },
    {
      id: "EVT-2026-03",
      nom: "Salon des Masters & Métiers du Numérique UFHB",
      ecoleOrganisatrice: "UFHB Cocody",
      date: "05 Juin 2026",
      lieu: "Amphithéâtre A du Campus Cocody",
      format: "Présentiel & Table Ronde",
      statut: "CLOTURE",
      budgetEngage: "1 200 000 FCFA",
      ambassadeursMobilises: ["Julie Konan", "Armand Kouassi"],
      cvsObjectif: 50,
      cvsCollectes: 74,
      actionsPrevues: "Animation table-ronde : 'La transformation digitale du secteur bancaire et télécoms en Côte d'Ivoire'"
    }
  ]);
  ...
  const [stagiairesPfe, setStagiairesPfe] = useState([
    {
      id: "PFE-2026-01",
      nom: "Kouamé Ange-Emmanuel",
      ecole: "INP-HB Yamoussoukro",
      filiere: "Génie Informatique (Dernière Année Ingénieur)",
      sujetPfe: "Implémentation d'une infrastructure Kubernetes multi-zones et monitoring Datadog",
      tuteurSII: "Moussa Soro (Responsable IT)",
      periode: "Avril - Septembre 2026",
      statutConversion: "PROPOSITION_CDI_EMISE", // EN_STAGE, PROPOSITION_CDI_EMISE, CDI_SIGNE, DEPART
      noteEvaluation: 4.8, // sur 5
      avisTuteur: "Profil brillant, déjà autonome sur la stack cloud. Proposition d'embauche immédiate transmise."
    },
    {
      id: "PFE-2026-02",
      nom: "Bamba Siriki",
      ecole: "ESATIC Abidjan",
      filiere: "Master 2 Cybersécurité & Audit SI",
      sujetPfe: "Mise en place d'un SOC interne et automatisation de la détection de phishing",
      tuteurSII: "Dr. Stéphane Touré & Expert Sécurité",
      periode: "Mai - Octobre 2026",
      statutConversion: "CDI_SIGNE",
      noteEvaluation: 4.9,
      avisTuteur: "Contrat CDI signé prenant effet au 1er novembre 2026 dès sa soutenance officielle de diplôme."
    },
    {
      id: "PFE-2026-03",
      nom: "Koffi Marie-Grâce",
      ecole: "UFHB Cocody (MIAGE)",
      filiere: "Master 2 MIAGE",
      sujetPfe: "Refonte du portail client et interfaçage avec les APIs de paiement Mobile Money",
      tuteurSII: "Julie Konan",
      periode: "Juin - Novembre 2026",
      statutConversion: "EN_STAGE",
      noteEvaluation: 4.5,
      avisTuteur: "Excellente intégration d'équipe, soutenance prévue mi-novembre, forte probabilité d'embauche."
    }
  ]);
