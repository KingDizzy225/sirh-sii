...
export function Payroll() {
    ...
    useEffect(() => {
        if (isHR) {
            ...
            loadAdvances();
            chargerCloture();
            if (activeTab === 'declarations') chargerDeclaration();
        }
        loadMyPayslips();
    ...
    useEffect(() => {
        if (isHR && activeTab === 'declarations') chargerRecapAnnuel();
    ...
    return (
        <div className="flex-1 space-y-6 p-8 pt-6 bg-slate-50 min-h-screen flex flex-col h-full relative">
            ...
            <div className="flex border-b border-slate-200/80 mb-6 gap-1 overflow-x-auto shrink-0 bg-slate-100/50 p-1 rounded-xl">
                {[
                    { id: 'run-payroll', label: 'Préparation de la Paie', icon: PlayCircle },
                    { id: 'history', label: 'Registre & Téléchargements', icon: Search },
                    { id: 'declarations', label: 'Déclarations Sociales & Fiscales (CI)', icon: Landmark },
                    { id: 'campaign', label: "Simulation d'augmentations", icon: PiggyBank },
                    { id: 'advances', label: 'Avances sur Salaire', icon: Banknote },
                ].map(tab => {
            ...
            <div className="flex-1 min-h-0">
                ...
                {/* 3. DÉCLARATIONS SOCIALES & FISCALES */}
                {isHR && activeTab === 'declarations' && (
                    <div className="space-y-6">
                        {/* 3 Téléchargements Fiscaux CI Rapides */}
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                            ...
                            <Card className="border-slate-200 shadow-md bg-gradient-to-br from-blue-900 to-indigo-950 text-white rounded-2xl overflow-hidden flex flex-col justify-between">
                                <CardHeader className="p-5">
                                    <Badge className="w-fit bg-blue-500/20 text-blue-300 border-blue-400/30 text-[10px] font-bold mb-2">
                                        CNPS Côte d'Ivoire
                                    </Badge>
                                    <CardTitle className="text-lg font-black text-white">DISA Annuelle</CardTitle>
                                    <CardDescription className="text-blue-200/80 text-xs mt-1">
                                        Déclaration Individuelle des Salaires Annuels conforme au format officiel de la CNPS.
                                    </CardDescription>
                                </CardHeader>
                                <CardContent className="p-5 pt-0 space-y-3">
                                    <div className="p-2.5 bg-white/10 rounded-xl text-[11px] space-y-1">
                                    ...
                                    <Button 
                                        ...
                                        className="w-full bg-blue-500 hover:bg-blue-400 text-white font-bold h-10 rounded-xl shadow-lg flex items-center justify-center gap-2 text-xs"
                                    >
                                        <Download size={16} /> Télécharger DISA (CSV)
                                    </Button>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="border-slate-200 shadow-md bg-gradient-to-br from-emerald-900 to-teal-950 text-white rounded-2xl overflow-hidden flex flex-col justify-between">
                                <CardHeader className="p-5">
                                    <Badge className="w-fit bg-emerald-500/20 text-emerald-300 border-emerald-400/30 text-[10px] font-bold mb-2">
                                        DGI & FDFP
                                    </Badge>
                                    <CardTitle className="text-lg font-black text-white">ITS & FDFP Mensuel</CardTitle>
                                    <CardDescription className="text-emerald-200/80 text-xs mt-1">
                                        État récapitulatif fiscal de l'ITS et taxes FDFP (Apprentissage 0.4% + Formation continue 0.6%).
                                    </CardDescription>
                                </CardHeader>
                                <CardContent className="p-5 pt-0 space-y-3">
                                    <div className="p-2.5 bg-white/10 rounded-xl text-[11px] space-y-1">
                                    ...
                                    <Button 
                                        ...
                                        className="w-full bg-emerald-500 hover:bg-emerald-400 text-white font-bold h-10 rounded-xl shadow-lg flex items-center justify-center gap-2 text-xs"
                                    >
                                        <Download size={16} /> Télécharger État DGI (CSV)
                                    </Button>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="border-slate-200 shadow-md bg-gradient-to-br from-purple-900 to-slate-950 text-white rounded-2xl overflow-hidden flex flex-col justify-between">
                                <CardHeader className="p-5">
                                    <Badge className="w-fit bg-purple-500/20 text-purple-300 border-purple-400/30 text-[10px] font-bold mb-2">
                                        Comptabilité
                                    </Badge>
                                    <CardTitle className="text-lg font-black text-white">Sage Ligne 100</CardTitle>
                                    <CardDescription className="text-purple-200/80 text-xs mt-1">
                                        Format d'intégration comptable pour le logiciel Sage Paie (Rubriques 1000, 2000, 4000).
                                    </CardDescription>
                                </CardHeader>
                                <CardContent className="p-5 pt-0 space-y-3">
                                    <div className="p-2.5 bg-white/10 rounded-xl text-[11px] space-y-1">
                                    ...
                                    <Button 
                                        ...
                                        className="w-full bg-purple-500 hover:bg-purple-400 text-white font-bold h-10 rounded-xl shadow-lg flex items-center justify-center gap-2 text-xs"
                                    >
                                        <Download size={16} /> Exporter Sage PNM
                                    </Button>
                                </CardContent>
                            </Card>
                        </div>
