...
export function EnquetesAccidents() {
  ...
  const [incidents, setIncidents] = useState([
    {
      id: "AT-2026-004",
      numeroCnps: "CNPS-DECL-2026-891",
      employeId: "EMP-0042",
      employeNom: "Mamadou Bakayoko",
      poste: "Technicien Réseaux & Baies Datacenter",
      departement: "Infrastructure & Systèmes",
      agence: "Siège Plateau (Tour Postel 2001)",
      dateAccident: "22/09/2026",
      heureAccident: "14:15",
      typeAccident: "TRAVAIL", // TRAVAIL, TRAJET, MALADIE
      circonstances: "Glissade sur marche d'escalier humide lors du transport de matériel réseau de rechange.",
      siegeLesion: "Cheville droite & Coude droit",
      natureLesion: "Entorse bénigne de la cheville avec contusion superficielle",
      joursArretPrescrits: 7,
      temoin: "Koffi N'Guessan (Ingénieur Réseau)",
      delaiCnpsHeuresRestantes: 22, // Moins de 48h
      statutCnps: "EN_ATTENTE_DEPOT", // EN_ATTENTE_DEPOT, TRANSMIS_DECHARGE, CLOTURE_INDEMNISE
      dateDepotCnps: null,
      medecinConstat: "Dr. Koné Lacina (Clinique Procréa Abidjan)",
      arbreCauses: {
        faitUltime: "Entorse cheville droite avec arrêt 7 jours",
        faitsDirects: ["Chute dans la cage d'escalier du 4ème étage", "Déséquilibre avec charge lourde (switch réseau)"],
        conditionsPrealables: [
          "Sol humide non balisé après nettoyage d'entretien",
          "Chaussures de sécurité avec semelle anti-dérapante usée",
          "Poids du carton supérieur à 15kg sans aide mécanique"
        ],
        causesProfondes: [
          "Absence de protocole de balisage lors du nettoyage en heures ouvrées",
          "Retard de renouvellement de la dotation annuelle des EPI (semelles)",
          "Procédure de transport de matériel lourd non formalisée"
        ],
        cinqPourquoi: [
          { p: "Pourquoi le technicien est-il tombé ?", r: "Il a glissé sur une marche de l'escalier." },
          { p: "Pourquoi a-t-il glissé ?", r: "Le sol était mouillé et ses chaussures n'ont pas adhéré." },
          { p: "Pourquoi le sol était-il mouillé sans signalisation ?", r: "L'équipe de ménage intervenait sans chevalet d'avertissement 'Sol Glissant'." },
          { p: "Pourquoi les chaussures n'ont-elles pas adhéré ?", r: "Les semelles de sécurité avaient 18 mois d'usure continue." },
          { p: "Pourquoi la dotation EPI n'a-t-elle pas été renouvelée ?", r: "Le bon de commande de renouvellement était bloqué en attente de visa budgétaire." }
        ]
      }
    },
    {
      id: "AT-2026-003",
      numeroCnps: "CNPS-DECL-2026-845",
      employeId: "EMP-0018",
      employeNom: "Julie Konan",
      poste: "Chargée de Clientèle Entreprises Senior",
      departement: "Banque d'Affaires & PME",
      agence: "Siège Plateau (Tour Postel 2001)",
      dateAccident: "10/09/2026",
      heureAccident: "07:45",
      typeAccident: "TRAJET",
      circonstances: "Collision de son véhicule de service avec un taxi wôrô-wôrô sur le Boulevard Lagunaire en venant au bureau.",
      siegeLesion: "Région cervicale (Coup du lapin)",
      natureLesion: "Traumatisme cervical sans fracture constatée à la radiographie",
      joursArretPrescrits: 10,
      temoin: "Constat amiable gendarmerie N° 2026/GEND/089",
      delaiCnpsHeuresRestantes: 0,
      statutCnps: "TRANSMIS_DECHARGE",
      dateDepotCnps: "11/09/2026 (Décharge Agence CNPS Plateau N° 4492)",
      medecinConstat: "Dr. Akoto (Polyclinique Sainte Anne-Marie PISAM)",
      arbreCauses: {
        faitUltime: "Entorse cervicale suite choc arrière",
        faitsDirects: ["Freinage d'urgence sur Boulevard lagunaire", "Choc violent par l'arrière"],
        conditionsPrealables: ["Ralentissement brusque du trafic", "Non respect des distances de sécurité par le tiers"],
        causesProfondes: ["Risque routier pendulaire aux heures de pointe"],
        cinqPourquoi: [
          { p: "Pourquoi la collaboratrice a-t-elle eu le coup du lapin ?", r: "Son véhicule a été percuté par l'arrière à un feu rouge." },
          { p: "Pourquoi la percussion était-elle violente ?", r: "Le véhicule tiers roulait à vitesse excessive sous la pluie." },
          { p: "Pourquoi était-elle sur cet itinéraire ?", r: "Trajet direct habituel entre son domicile à Cocody et le siège au Plateau." },
          { p: "Y avait-il une déviation ou motif personnel ?", r: "Non, itinéraire le plus direct vérifié sur le PV d'accident de trajet." },
          { p: "La prise en charge CNPS est-elle acquise ?", r: "Oui, qualification accident de trajet validée par le médecin conseil CNPS." }
        ]
      }
    },
    {
      id: "AT-2026-002",
      numeroCnps: "CNPS-DECL-2026-720",
      employeId: "EMP-0089",
      employeNom: "Kouamé N'Dri",
      poste: "Chauffeur de Direction",
      departement: "Services Généraux & Logistique",
      agence: "Agence Cocody Ambassades",
      dateAccident: "28/08/2026",
      heureAccident: "16:30",
      typeAccident: "TRAVAIL",
      circonstances: "Coupure profonde à la paume de la main gauche en refermant le capot moteur lors de la vérification des niveaux.",
      siegeLesion: "Main gauche (Face palmaire)",
      natureLesion: "Plaie nette nécessitant 4 points de suture",
      joursArretPrescrits: 3,
      temoin: "Moussa Soro (Responsable Flotte)",
      delaiCnpsHeuresRestantes: 0,
      statutCnps: "CLOTURE_INDEMNISE",
      dateDepotCnps: "29/08/2026 (Dossier clos & IJ perçues)",
      medecinConstat: "Dr. Bamba (Centre Médical Inter-entreprises)",
      arbreCauses: {
        faitUltime: "Plaie palmaire suturée avec 3 jours d'ITT",
        faitsDirects: ["Fermeture brutale du capot par vent violent", "Main posée sur la traverse tranchante"],
        conditionsPrealables: ["Tige de maintien du capot tordue", "Absence de gants de manutention"],
        causesProfondes: ["Défaut de maintenance préventive de la béquille de capot"],
        cinqPourquoi: [
          { p: "Pourquoi la main a-t-elle été coupée ?", r: "Le capot métallique est retombé sur la main." },
          { p: "Pourquoi la tige de maintien n'a-t-elle pas tenu ?", r: "L'ergot était faussé lors de la dernière vidange." },
          { p: "Pourquoi le chauffeur ne portait-il pas de gants ?", r: "Les gants étaient rangés dans la boîte à gants et non portés." },
          { p: "Pourquoi la tige défectueuse n'a-t-elle pas été signalée ?", r: "Pas de fiche de contrôle de pré-départ renseignée." },
          { p: "Quelle action corrective ?", r: "Remplacement immédiat de la béquille et check-list sécurité obligatoire." }
        ]
      }
    }
  ]);
