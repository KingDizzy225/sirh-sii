...
const getAllNavItems = (t) => [
    ...
    { name: 'Cahier des Doléances Délégués', path: '/doleances-delegues', icon: Vote, domain: 'Employés', permission: 'employees:edit' },
    ...
    { name: 'Entretiens de Départ (Exit)', path: '/entretiens-depart', icon: LogOut, domain: 'Employés', permission: 'employees:edit', manager: true },
    ...
    { name: 'Simulateur Embauche Brut/Net (CI)', path: '/simulateur-embauche', icon: Calculator, domain: 'Pilotage RH', permission: 'payroll:view' },
    ...
    { name: 'Gestion & Remboursement FDFP', path: '/fdfp-gestion', icon: PiggyBank, domain: 'Pilotage RH', permission: 'learning:view' },
    { name: 'Compétences & Matrice 9-Box', path: '/skills', icon: Award, domain: 'Pilotage RH', permission: 'skills:view' },
    { name: 'Marketplace des Talents', path: '/marketplace-talents', icon: Sparkles, domain: 'Pilotage RH', permission: 'skills:view' },
